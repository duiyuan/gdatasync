...
func (o *Options) Complete() error {
	if runtime.GOOS == "windows" {
		...
		if len(o.ErrorOutputPaths) > 0 {
			index := util.FindIndex(o.ErrorOutputPaths, func(s string) bool { return strings.HasSuffix(s, ".log") })
			if index > -1 {
				file := o.ErrorOutputPaths[index]
				o.ErrorOutputPaths[index] = util.FixWindowsPath(file)
			}
		}
	}
	return nil
